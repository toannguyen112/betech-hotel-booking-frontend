  ...
  return (
    <Link to={`/room/${props.id}`} className="md:col-span-6 col-span-12">
      <div className="bg-white  grid grid-cols-3 rounded-md p-3 space-x-[12px] shadow-2xl hover:shadow-lg transition-all cursor-pointer">
        <div className="col-span-1"><img src={props.images && props.images.length ? props.images[0].path : "https://via.placeholder.com/150"} alt={props.name} className="aspect-square  object-cover round-[20px]" /></div>
